		...
		try {
			...
			switch(command) {
				...
				case 'nekonime':
					...
					client.sendMessage(from, nekonime, image, {quoted: mek, caption: '>///<'})
					break
				case 'tahta':
					teks = body.slice(7)
				...
				case 'artinama':
					teks = body.slice(10)
					anu = await fetchJson(`https://arugaz.herokuapp.com/artinama?nama=${teks}`, {method: 'get'})
					hasil = `*Artina Nama ${teks}*\n\n${anu.result.}`
