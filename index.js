	...
	client.on('message-new', async (mek) => {
		try {
			...
			switch(command) {
				...
				case 'nekonime':
					teks = body.slice(9)
					nekonime = await getBuffer(`https://api.vhtear.com/hartatahta?text=${teks}&apikey=${vkey}`, {method: 'get'})
				...
				case 'marvel':
					...
					mv1 = gh.split(" ")[0];
					mv2 = gh.split(" ")[1];
					anu = await fetchJson(`https://hujanapi.herokuapp.com/api/marvel_studio?text1=${mv1}&text2=${mv2}&apiKey=rdtt0OayDCuS8LAAE3vZ`, {method: 'get'})
